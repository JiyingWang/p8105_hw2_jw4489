...
characteristics of the participants. The dataset contains 479 rows and 6
columns.

479 participants were recruited, and 93 participants develop MCI. The
average baseline age is 65. The proportion of women in the study are
...
datasets. 16 participants are only in the amyloid dataset, and 8
...
The resulting dataset contains 471 rows and 11 columns.
